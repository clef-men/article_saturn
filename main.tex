...
The \Iris way to formulate linearizability is through \emph{logically atomic specifications}~\cite{DBLP:conf/ecoop/PintoDG14}, which have been proven to be equivalent~\cite{DBLP:journals/pacmpl/BirkedalDGJST21} in sequentially consistent memory models.
